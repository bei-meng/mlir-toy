  ...
  func.func @fc_relu(%arg0: memref<16x32xf32>, %arg1: memref<32x16xf32>, %arg2: memref<16x16xf32>, %arg3: memref<16x16xf32>) {
      ...
      affine.for %arg5 = 0 to 16 step 4 {
        affine.for %arg6 = #map(%arg4) to #map1(%arg4) {
          affine.for %arg7 = #map(%arg5) to #map1(%arg5) {
            affine.store %cst, %arg3[%arg6, %arg7] : memref<16x16xf32>
          }
        }
      }
    }
          ...
          affine.for %arg7 = #map(%arg4) to #map1(%arg4) {
            affine.for %arg8 = #map(%arg5) to #map1(%arg5) {
              affine.for %arg9 = #map(%arg6) to #map1(%arg6) {
                %0 = affine.load %arg0[%arg7, %arg9] : memref<16x32xf32>
                %1 = affine.load %arg1[%arg9, %arg8] : memref<32x16xf32>
    ...
    affine.for %arg4 = 0 to 16 step 4 {
      affine.for %arg5 = 0 to 16 step 4 {
        affine.for %arg6 = #map(%arg4) to #map1(%arg4) {
          affine.for %arg7 = #map(%arg5) to #map1(%arg5) {
            %0 = affine.load %arg3[%arg6, %arg7] : memref<16x16xf32>
            %1 = affine.load %arg2[%arg6, %arg7] : memref<16x16xf32>
            %2 = arith.addf %0, %1 : f32
            affine.store %2, %arg3[%arg6, %arg7] : memref<16x16xf32>
          }
        }
      }
    }
      ...
      affine.for %arg5 = 0 to 16 step 4 {
        affine.for %arg6 = #map(%arg4) to #map1(%arg4) {
          affine.for %arg7 = #map(%arg5) to #map1(%arg5) {
            ...
            affine.store %1, %arg3[%arg6, %arg7] : memref<16x16xf32>
          }
        }
      }
    }
