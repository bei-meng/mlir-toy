        ...
        affine.for %arg6 = 0 to 32 step 4 {
          affine.for %arg7 = #map(%arg4) to #map1(%arg4) {
            affine.for %arg8 = #map(%arg5) to #map1(%arg5) {
              ...
              affine.store %8, %arg3[%arg7, %arg8] : memref<16x16xf32>
              %9 = affine.load %arg0[%arg7, %arg6 + 2] : memref<16x32xf32>
              %10 = affine.load %arg1[%arg6 + 2, %arg8] : memref<32x16xf32>
              %11 = arith.mulf %9, %10 : f32
              %12 = arith.addf %8, %11 : f32
              affine.store %12, %arg3[%arg7, %arg8] : memref<16x16xf32>
              %13 = affine.load %arg0[%arg7, %arg6 + 3] : memref<16x32xf32>
              %14 = affine.load %arg1[%arg6 + 3, %arg8] : memref<32x16xf32>
              %15 = arith.mulf %13, %14 : f32
              %16 = arith.addf %12, %15 : f32
              affine.store %16, %arg3[%arg7, %arg8] : memref<16x16xf32>
            }
          }
        }
      }
